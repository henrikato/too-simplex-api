//https://github.com/RodrigoRodriguesX10/DoSimplex

export const Matriz = (x, y) => {
...
export const find_pivot_column = tab => {
    let j, pivot_col = 1;
...
export const find_pivot_row = (tab, pivot_col) => {
...
export const calculateZLine = (tab, final) => {
    var newZ = [];
    if (!final) {
        for (i = 0; i < tab.n; i++) {
            newZ.push(0);
...
export const criarFuncaoObjetivo = tab => {
    tab.funcaoObjetivo = tab.tableau[0].slice();
}

export const simplex = (tab, iteracoes) => {
...
export const createCopy = tableau => {
...
export const getSensibilityTable = final => {
